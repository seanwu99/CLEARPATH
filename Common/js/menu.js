	...
	var mes_href = location.href.substring (0, location.href.indexOf('SPCM')) + "MESM/";
	...
	// Create the items and add them to the menu 1------------------	Application Setup		-------------------------------------	
		...
		//----------------------SPC---------------------------------------
		// oMenu1.addItem(new sap.ui.commons.HorizontalDivider());
		var oMenuItem6 = new sap.ui.commons.MenuItem("item1-0-6",{text: "SPCM Home", enabled: false});
		//oMenuItem6.setStartsSection(true);
...
//Attach an event to raise an alert when an item is selected (Button 1)
	...
	oMenuButton1.attachItemSelected(function (oEvent){
		...
		switch( oEvent.getParameter("itemId")) {
			...
			case "item1-4-1":
				setTimeout("location.href = '"+mes_href + "MgtHierarchy.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
			case "item1-4-2":
				setTimeout("location.href = '"+mes_href + "LvlHierarchy.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;

			// SubMenu Settings 5

			case "item1-5-1":
				setTimeout("location.href = '"+mes_href + "MemMapTags.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
			case "item1-5-2":
				setTimeout("location.href = '"+mes_href + "MemMapTrxs.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
			case "item1-5-3":
				setTimeout("location.href = '"+mes_href + "TagCommGroups.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
			case "item1-5-4":
				setTimeout("location.href = '"+mes_href + "TagTypes.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
			case "item1-5-5":
				setTimeout("location.href = '"+mes_href + "TagFunctions.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;

			// SubMenu Settings 6

			case "item1-6-1":
				setTimeout("location.href = '"+mes_href + "Operators.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
			case "item1-6-2":
				setTimeout("location.href = '"+mes_href + "Stations.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
			case "item1-6-3":
				setTimeout("location.href = '"+mes_href + "Printers.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
			case "item1-6-4":
				setTimeout("location.href = '"+mes_href + "PCoServers.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
			case "item1-6-5":
				setTimeout("location.href = '"+mes_href + "PCoAgents.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
			case "item1-6-6":
				setTimeout("location.href = '"+mes_href + "SqlServers.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
			case "item1-6-7":
				setTimeout("location.href = '"+mes_href + "PCoFileServers.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
			break;
				case "item1-6-8":
				setTimeout("location.href = '"+mes_href + "PCoFileAgents.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
			break;

			// SubMenu Settings 7

			case "item1-7-1":
				setTimeout("location.href = '"+mes_href + "UnitsOfMeasure.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
			case "item1-7-2":
				setTimeout("location.href = '"+mes_href + "ProductsMgmt.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
			case "item1-7-3":
				setTimeout("location.href = '"+mes_href + "BomMgmt.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
			case "item1-7-4":
				setTimeout( "location.href = '"+mes_href + "RoutingMgmt.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;

			// SPC Home

			case "item1-0-6":
				setTimeout("location.href = '"+ "SPCM.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
			...
			case "item1-8-2":
				...
				setTimeout("location.href = '"+"ImportPlants.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
			case "item1-8-3":
				// document.location.href = 'ExportPlants.irpt?ROLE=' + document.getElementById("user_role").value;
				setTimeout("location.href = '"+"ExportPlants.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
		...
		// SubMenu Settings 9
			...
			case "item1-9-2":
				...
				setTimeout("location.href = '"+"ImportStations.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
			case "item1-9-3":
				// document.location.href = 'ExportStations.irpt?ROLE=' + document.getElementById("user_role").value;
				setTimeout("location.href = '"+"ExportStations.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
		...
		// SubMenu Settings 10
			...
			case "item1-10-1":
				...
				setTimeout("location.href = '"+"Parts.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
			case "item1-10-2":
				// document.location.href = 'ImportParts.irpt?ROLE=' + document.getElementById("user_role").value;
				setTimeout("location.href = '"+"ImportParts.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
			case "item1-10-3":
				// document.location.href = 'ExportParts.irpt?ROLE=' + document.getElementById("user_role").value;
				setTimeout("location.href = '"+"ExportParts.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
		...
		// SubMenu Settings 11
			...
			case "item1-11-1":
				...
				setTimeout("location.href = '"+"DatapointsHDR.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
			case "item1-11-2":
				// document.location.href = 'DatapointsSPC.irpt?ROLE=' + document.getElementById("user_role").value;
				setTimeout("location.href = '"+"DatapointsSPC.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
			case "item1-11-3":
				// document.location.href = 'ImportDatapoints.irpt?ROLE=' + document.getElementById("user_role").value;
				setTimeout("location.href = '"+"ImportDatapoints.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
			case "item1-11-4":
				// document.location.href = 'ExportDatapoints.irpt?ROLE=' + document.getElementById("user_role").value;
				setTimeout("location.href = '"+"ExportDatapoints.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
		...
		// SubMenu Settings 12
			...
			case "item1-12-2":
				...
				setTimeout("location.href = '"+"ImportOperators.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
			case "item1-12-3":
				// document.location.href = 'ExportOperators.irpt?ROLE=' + document.getElementById("user_role").value;
				setTimeout("location.href = '"+"ExportOperators.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
		...
		// SubMenu Settings 13
			...
			case "item1-13-1":
				...
				setTimeout("location.href = '"+"Subscriptions.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
			case "item1-13-2":
				// document.location.href = 'ImportSubscriptions.irpt?ROLE=' + document.getElementById("user_role").value;
				setTimeout("location.href = '"+"ImportSubscriptions.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
			case "item1-13-3":
				 // document.location.href = 'ExportSubscriptions.irpt?ROLE=' + document.getElementById("user_role").value;
				setTimeout("location.href = '"+"ExportSubscriptions.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
...
//Attach an event to raise an alert when an item is selected (Button 2)
	...
	oMenuButton2.attachItemSelected(function (oEvent){
		switch( oEvent.getParameter("itemId")) {
			case "item2-0-1":
				setTimeout("location.href = '"+mes_href + "WorkOrders.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
			case "item2-0-2":
				setTimeout("location.href = '"+mes_href + "CarrierDashboard.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
			case "item2-0-3":
				setTimeout("location.href = '"+mes_href + "AssemblyDashboard.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
			case "item2-0-4":
				// document.location.href = 'SPCDashboard.irpt?ROLE=' + document.getElementById("user_role").value;
				setTimeout("location.href = '"+"SPCDashboard.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
			default:
				// alert("Items \"" + oEvent.getParameter("itemId") + "\" was selected.");
				break;
...
//Attach an event to raise an alert when an item is selected. (Button 3)
	...
	oMenuButton3.attachItemSelected(function (oEvent){
		switch( oEvent.getParameter("itemId")) {
			// Menu Reports
			case "item3-0-1":
				setTimeout("location.href = '"+mes_href + "ProductionStatus.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
			case "item3-0-2":
				setTimeout("location.href = '"+mes_href + "ItemTraceability.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
			case "item3-0-3":
				setTimeout("location.href = '"+mes_href + "MESM.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
			case "item3-0-4":
				// document.location.href = 'DailyReport.irpt?ROLE=' + document.getElementById("user_role").value;
				setTimeout("location.href = '"+"DailyReport.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
			case "item3-0-5":
				// document.location.href = 'WeeklyReport.irpt?ROLE=' + document.getElementById("user_role").value;
				setTimeout("location.href = '"+"WeeklyReport.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
			case "item3-0-6":
				// document.location.href = 'MonthlyReport.irpt?ROLE=' + document.getElementById("user_role").value;
				setTimeout("location.href = '"+"MonthlyReport.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
			default:
				//alert("Items \"" + oEvent.getParameter("itemId") + "\" was selected.");
				break;
