        ...
        tablesorter: new function () {
            ...
            function buildParserCache(e, t) {
                ...
                if (0 != e.tBodies.length) {
                    ...
                    if (n[0]) for (var o = [], a = n[0].cells.length, i = 0; i < a; i++) {
                        var s = !1;
                        $.metadata && $(t[i]).metadata() && $(t[i]).metadata().sorter ? s = getParserById($(t[i]).metadata().sorter) : e.config.headers[i] && e.config.headers[i].sorter && (s = getParserById(e.config.headers[i].sorter)), s || (s = detectParserForColumn(e, n, -1, i)), e.config.debug && (r += "column:" + i + " parser:" + s.id + "\n"), o.push(s)
                    }
            ...
            function detectParserForColumn(e, t, r, n) {
                for (var o = parsers.length, a = !1, i = !1, s = !0; "" == i && s;) t[++r] ? (a = getNodeFromRowAndCellIndex(t, r, n), i = trimAndGetNodeText(e.config, a), e.config.debug && log("Checking if value was empty on row:" + r)) : s = !1;
                for (var d = 1; d < o; d++) if (parsers[d].is(i, e, a)) return parsers[d];
                return parsers[0]
            }
            ...
            function getParserById(e) {
                for (var t = parsers.length, r = 0; r < t; r++) if (parsers[r].id.toLowerCase() == e.toLowerCase()) return parsers[r];
                return !1
            }
            ...
            function appendToTable(e, t) {
                ...
                for (var n = t, o = n.row, a = n.normalized, i = a.length, s = a[0].length - 1, d = $(e.tBodies[0]), c = [], l = 0; l < i; l++) {
                    var u = a[l][s];
                    if (c.push(o[u]), !e.config.appender) for (var f = o[u].length, h = 0; h < f; h++) d[0].appendChild(o[u][h])
                }
            ...
            function computeTableHeaderCellIndexes(e) {
                for (var t = [], r = {}, n = e.getElementsByTagName("THEAD")[0].getElementsByTagName("TR"), o = 0; o < n.length; o++) for (var a = n[o].cells, i = 0; i < a.length; i++) {
                    var s, d = a[i], c = d.parentNode.rowIndex, l = c + "-" + d.cellIndex, u = d.rowSpan || 1,
                        f = d.colSpan || 1;
                    void 0 === t[c] && (t[c] = []);
                    for (h = 0; h < t[c].length + 1; h++) if (void 0 === t[c][h]) {
                        s = h;
                        break
                    }
                    r[l] = s;
            ...
            function getWidgetById(e) {
                for (var t = widgets.length, r = 0; r < t; r++) if (widgets[r].id.toLowerCase() == e.toLowerCase()) return widgets[r]
            }
            ...
            function isValueInArray(e, t) {
                for (var r = t.length, n = 0; n < r; n++) if (t[n][0] == e) return !0;
                return !1
            }
            ...
            this.defaults = {
                    ...
                    if (this.tHead && this.tBodies) {
                        ...
                        fixColumnWidth(this), r.click(function (e) {
                            ...
                            if (!this.sortDisabled && i > 0) {
                                ...
                                $(this);
                                var s = this.column;
                                if (this.order = this.count++ % 2, this.lockedOrder && (this.order = this.lockedOrder), e[o.sortMultiSortKey]) if (isValueInArray(s, o.sortList)) for (u = 0; u < o.sortList.length; u++) {
                                    var d = o.sortList[u], c = o.headerList[d[0]];
                                    d[0] == s && (c.count = d[1], c.count++, d[1] = c.count % 2)
                                } else o.sortList.push([s, this.order]); else {
                                    if (o.sortList = [], null != o.sortForce) for (var l = o.sortForce, u = 0; u < l.length; u++) l[u][0] != s && o.sortList.push(l[u]);
                            ...
                            var i = o.sortList;
                            updateHeaderSortCount(this, i), setHeadersCss(0, r, i, a), appendToTable(this, multisort(this, i, n))
                ...
                }.apply(e.tBodies[0]) : e.tBodies[0].innerHTML = ""
            }
        }
