        ...
        1: [function (t, e, i) {
            ...
            function a(t) {
                if (t) {
                    ...
                    if (s) {
                        s = s[1];
                        for (u = 0; u < r.length; u++) r[u] = parseInt(s[u] + s[u], 16)
                    } else if (s = t.match(i)) {
                        s = s[1];
                        for (u = 0; u < r.length; u++) r[u] = parseInt(s.slice(2 * u, 2 * u + 2), 16)
                    } else if (s = t.match(a)) {
                        for (u = 0; u < r.length; u++) r[u] = parseInt(s[u + 1]);
                        l = parseFloat(s[4])
                    } else if (s = t.match(n)) {
                        for (u = 0; u < r.length; u++) r[u] = Math.round(2.55 * parseFloat(s[u + 1]));
                        l = parseFloat(s[4])
                    } else if (s = t.match(o)) {
                        if ("transparent" == s[1]) return [0, 0, 0, 0];
                        if (!(r = c[s[1]])) return
                    }
                    for (var u = 0; u < r.length; u++) r[u] = d(r[u], 0, 255);
            ...
            var c = t(6);
            e.exports = {
                getRgba: a, getHsla: n, getRgb: function (t) {
                    var e = a(t);
            ...
            o.prototype = {
                rgb: function () {
                    ...
                    var i = this, a = t, n = void 0 === e ? .5 : e, o = 2 * n - 1, r = i.alpha() - a.alpha(),
                    ...
                    var t, e, i = new o, a = this.values, n = i.values;
                    for (var r in a) a.hasOwnProperty(r) && (t = a[r], "[object Array]" === (e = {}.toString.call(t)) ? n[r] = t.slice(0) : "[object Number]" === e ? n[r] = t : console.error("unexpected color value:", t));
                    return i
                }
            }, o.prototype.spaces = {
                rgb: ["red", "green", "blue"],
                ...
                var i, n = this.values, o = this.spaces, r = this.maxes, l = 1;
                ...
                var d;
                for (i = 0; i < t.length; i++) d = Math.max(0, Math.min(r[t][i], n[t][i])), n[t][i] = Math.round(d);
                for (var u in o) u !== t && (n[u] = a[t][u](n[t]));
                return !0
            ...
            function a(t) {
                var e, i, a, n = t[0] / 255, o = t[1] / 255, r = t[2] / 255, l = Math.min(n, o, r),
            ...
            function n(t) {
                var e, i, a, n = t[0], o = t[1], r = t[2], l = Math.min(n, o, r), s = Math.max(n, o, r), d = s - l;
            ...
            function l(t) {
                var e, i, a, n, o = t[0] / 255, r = t[1] / 255, l = t[2] / 255;
            ...
            function u(t) {
                var e, i, a, n = d(t), o = n[0], r = n[1], l = n[2];
            ...
            function c(t) {
                var e, i, a, n, o, r = t[0] / 360, l = t[1] / 100, s = t[2] / 100;
                if (0 == l) return o = 255 * s, [o, o, o];
                e = 2 * s - (i = s < .5 ? s * (1 + l) : s + l - s * l), n = [0, 0, 0];
                for (var d = 0; d < 3; d++) (a = r + 1 / 3 * -(d - 1)) < 0 && a++, a > 1 && a--, o = 6 * a < 1 ? e + 6 * (i - e) * a : 2 * a < 1 ? i : 3 * a < 2 ? e + (i - e) * (2 / 3 - a) * 6 : e, n[d] = 255 * o;
                return n
            }

            function h(t) {
                var e = t[0] / 60, i = t[1] / 100, a = t[2] / 100, n = Math.floor(e) % 6, o = e - Math.floor(e),
                    r = 255 * a * (1 - i), l = 255 * a * (1 - i * o), s = 255 * a * (1 - i * (1 - o)), a = 255 * a;
                switch (n) {
                    case 0:
                        return [a, s, r];
                    case 1:
            ...
            function f(t) {
                var e, i, a, n, o = t[0] / 360, l = t[1] / 100, s = t[2] / 100, d = l + s;
            ...
            e.exports = {
                ...
                hsl2rgb: c,
                hsl2hsv: function (t) {
                    var e, i, a = t[0], n = t[1] / 100, o = t[2] / 100;
            ...
            for (var D in M) C[JSON.stringify(M[D])] = D
        }, {}], 5: [function (t, e, i) {
            var a = t(4), n = function () {
                return new d
            };
            for (var o in a) {
                n[o + "Raw"] = function (t) {
            ...
            e.exports = function (t) {
                ...
                t.defaults.bar = {
                    ...
                    calculateBarBase: function (t, e) {
                        var i = this, a = i.getMeta(), n = i.getScaleForId(a.yAxisID), o = 0;
                    ...
                    getRuler: function (t) {
                        var e, i = this, a = i.getMeta(), n = i.getScaleForId(a.xAxisID), o = i.getBarCount(),
                            ...
                            l = (e - e * n.options.categoryPercentage) / 2, s = r / o;
                    ...
                    calculateBarX: function (t, e, i) {
                        var a = this, n = a.getMeta(), o = a.getScaleForId(n.xAxisID), r = a.getBarIndex(e),
                    ...
                    calculateBarY: function (t, e) {
                        var i = this, a = i.getMeta(), n = i.getScaleForId(a.yAxisID),
                            o = Number(i.getDataset().data[t]);
                        if (n.options.stacked) {
                            for (var r = 0, l = 0, s = 0; s < e; s++) {
                                var d = i.chart.data.datasets[s], u = i.chart.getDatasetMeta(s);
                    ...
                    draw: function (t) {
                        var e, i, a = this, n = t || 1, o = a.getMeta().data, r = a.getDataset();
                    ...
                    setHoverStyle: function (t) {
                        var i = this.chart.data.datasets[t._datasetIndex], a = t._index, n = t.custom || {},
                            o = t._model;
                    ...
                    updateElement: function (t, i, a) {
                        ...
                        t._model = {
                            ...
                            var e = this._chart.ctx, i = this._view, a = i.height / 2, n = i.y - a, o = i.y + a,
                                r = i.base - (i.base - i.x), l = i.borderWidth / 2;
                        ...
                        var i = this, a = i.getMeta(), n = i.getScaleForId(a.xAxisID), o = 0;
                        if (n.options.stacked) {
                            for (var r = i.chart, l = r.data.datasets, s = Number(l[t].data[e]), d = 0; d < t; d++) {
                                var u = l[d], c = r.getDatasetMeta(d);
                        ...
                        var e, i = this, a = i.getMeta(), n = i.getScaleForId(a.yAxisID), o = i.getBarCount(),
                            r = (e = "category" === n.options.type ? n.getPixelForTick(t + 1) - n.getPixelForTick(t) : n.width / n.ticks.length) * n.options.categoryPercentage,
                            l = (e - e * n.options.categoryPercentage) / 2, s = r / o;
                        return n.ticks.length !== i.chart.data.labels.length && (s *= n.ticks.length / i.chart.data.labels.length), {
                            datasetCount: o,
                        ...
                        var a = this, n = a.getMeta(), o = a.getScaleForId(n.yAxisID), r = a.getBarIndex(e),
                            l = o.getPixelForValue(null, t, e, a.chart.isCombo);
                ...
                t.defaults.bubble = {
                    ...
                    updateElement: function (i, a, n) {
                        var o = this, r = o.getMeta(), l = o.getScaleForId(r.xAxisID), s = o.getScaleForId(r.yAxisID),
                            d = i.custom || {}, u = o.getDataset(), c = u.data[a], h = o.chart.options.elements.point,
                            f = o.index;
                        e.extend(i, {
                            _xScale: l,
                            _yScale: s,
                    ...
                    setHoverStyle: function (i) {
                        ...
                        var n = a.chart.data.datasets[i._datasetIndex], o = i._index, r = i.custom || {};
                    ...
                    removeHoverStyle: function (e) {
                        ...
                        var a = i.chart.data.datasets[e._datasetIndex].data[e._index], n = e.custom || {};
            ...
            e.exports = function (t) {
                ...
                i.doughnut = {
                    ...
                    legendCallback: function (t) {
                        ...
                        var i = t.data, a = i.datasets, n = i.labels;
                        if (a.length) for (var o = 0; o < a[0].data.length; ++o) e.push('<li><span style="background-color:' + a[0].backgroundColor[o] + '"></span>'), n[o] && e.push(n[o]), e.push("</li>");
                        ...
                        labels: {
                            generateLabels: function (t) {
                                ...
                                return i.labels.length && i.datasets.length ? i.labels.map(function (a, n) {
                                    var o = t.getDatasetMeta(0), r = i.datasets[0], l = o.data[n],
                            ...
                            var i, a, n, o = e.index, r = this.chart;
                            for (i = 0, a = (r.data.datasets || []).length; i < a; ++i) (n = r.getDatasetMeta(i)).data[o] && (n.data[o].hidden = !n.data[o].hidden);
                            r.update()
                        }
                    },
                    cutoutPercentage: 50,
                    ...
                    tooltips: {
                        callbacks: {
                            title: function () {
                                ...
                                var a = i.labels[t.index], n = ": " + i.datasets[t.datasetIndex].data[t.index];
                    ...
                    update: function (t) {
                        var i = this, a = i.chart, n = a.chartArea, o = a.options, r = o.elements.arc,
                            l = n.right - n.left - r.borderWidth, s = n.bottom - n.top - r.borderWidth,
                            d = Math.min(l, s), u = {x: 0, y: 0}, c = i.getMeta(), h = o.cutoutPercentage,
                            f = o.circumference;
                        if (f < 2 * Math.PI) {
                            var g = o.rotation % (2 * Math.PI),
                                p = (g += 2 * Math.PI * (g >= Math.PI ? -1 : g < -Math.PI ? 1 : 0)) + f,
                                m = {x: Math.cos(g), y: Math.sin(g)}, b = {x: Math.cos(p), y: Math.sin(p)},
                            ...
                            d = Math.min(l / C.width, s / C.height), u = {x: -.5 * (M.x + w.x), y: -.5 * (M.y + w.y)}
                        }
                    ...
                    updateElement: function (t, i, a) {
                        var n = this, o = n.chart, r = o.chartArea, l = o.options, s = l.animation,
                            ...
                            p = a && s.animateScale ? 0 : n.innerRadius, m = a && s.animateScale ? 0 : n.outerRadius,
                    ...
                    calculateTotal: function () {
                        var t, i = this.getDataset(), a = this.getMeta(), n = 0;
                    ...
                    getMaxBorderWidth: function (t) {
                        for (var e, i, a = 0, n = this.index, o = t.length, r = 0; r < o; r++) e = t[r]._model ? t[r]._model.borderWidth : 0, a = (i = t[r]._chart ? t[r]._chart.config.data.datasets[n].hoverBorderWidth : 0) > (a = e > a ? e : a) ? i : a;
                        return a
                    }
                })
            }
            ...
            e.exports = function (t) {
                ...
                t.defaults.line = {
                    ...
                    dataElementType: t.elements.Point,
                    update: function (t) {
                        var a, n, o, r = this, l = r.getMeta(), s = l.dataset, d = l.data || [], u = r.chart.options,
                        ...
                        }, s.pivot()), a = 0, n = d.length; a < n; ++a) r.updateElement(d[a], a, t);
                        for (g && 0 !== s._model.tension && r.updateBezierControlPoints(), a = 0, n = d.length; a < n; ++a) d[a].pivot()
                    },
                    getPointBackgroundColor: function (t, e) {
                        var a = this.chart.options.elements.point.backgroundColor, n = this.getDataset(),
                            o = t.custom || {};
                    ...
                    getPointBorderColor: function (t, e) {
                        var a = this.chart.options.elements.point.borderColor, n = this.getDataset(),
                            o = t.custom || {};
                    ...
                    getPointBorderWidth: function (t, e) {
                        var a = this.chart.options.elements.point.borderWidth, n = this.getDataset(),
                            o = t.custom || {};
                    ...
                    calculatePointY: function (t, e, i) {
                        var a, n, o, r = this, l = r.chart, s = r.getMeta(), d = r.getScaleForId(s.yAxisID), u = 0,
                            c = 0;
                        if (d.options.stacked) {
                            for (a = 0; a < i; a++) if (n = l.data.datasets[a], "line" === (o = l.getDatasetMeta(a)).type && o.yAxisID === d.id && l.isDatasetVisible(a)) {
                    ...
                    updateBezierControlPoints: function () {
                        ...
                        var e, a, n, o, r = this, l = r.getMeta(), s = r.chart.chartArea, d = l.data || [];
                        if (l.dataset._model.spanGaps && (d = d.filter(function (t) {
                                return !t._model.skip
                            })), "monotone" === l.dataset._model.cubicInterpolationMode) i.splineCurveMonotone(d); else for (e = 0, a = d.length; e < a; ++e) n = d[e]._model, o = i.splineCurve(i.previousItem(d, e)._model, n, i.nextItem(d, e)._model, l.dataset._model.tension), n.controlPointPreviousX = o.previous.x, n.controlPointPreviousY = o.previous.y, n.controlPointNextX = o.next.x, n.controlPointNextY = o.next.y;
                        if (r.chart.options.elements.line.capBezierPoints) for (e = 0, a = d.length; e < a; ++e) (n = d[e]._model).controlPointPreviousX = t(n.controlPointPreviousX, s.left, s.right), n.controlPointPreviousY = t(n.controlPointPreviousY, s.top, s.bottom), n.controlPointNextX = t(n.controlPointNextX, s.left, s.right), n.controlPointNextY = t(n.controlPointNextY, s.top, s.bottom)
                    },
                    draw: function (t) {
                        var i, a, n = this, o = n.getMeta(), r = o.data || [], l = t || 1;
                        for (i = 0, a = r.length; i < a; ++i) r[i].transition(l);
                        for (e(n.getDataset(), n.chart.options) && o.dataset.transition(l).draw(), i = 0, a = r.length; i < a; ++i) r[i].draw()
                    },
                    setHoverStyle: function (t) {
                    ...
                    removeHoverStyle: function (t) {
                        var e = this, a = e.chart.data.datasets[t._datasetIndex], n = t._index, o = t.custom || {},
                            r = t._model;
            ...
            e.exports = function (t) {
                ...
                t.defaults.polarArea = {
                    ...
                    legend: {
                        labels: {
                            generateLabels: function (t) {
                                var i = t.data;
                                return i.labels.length && i.datasets.length ? i.labels.map(function (a, n) {
                                    var o = t.getDatasetMeta(0), r = i.datasets[0], l = o.data[n].custom || {},
                                        s = e.getValueAtIndexOrDefault, d = t.options.elements.arc;
                                    return {
                                        text: a,
                            ...
                            var i, a, n, o = e.index, r = this.chart;
                            for (i = 0, a = (r.data.datasets || []).length; i < a; ++i) (n = r.getDatasetMeta(i)).data[o].hidden = !n.data[o].hidden;
                            r.update()
                        }
                    },
                    tooltips: {
                    ...
                    linkScales: e.noop,
                    update: function (t) {
                        var i = this, a = i.chart, n = a.chartArea, o = i.getMeta(), r = a.options, l = r.elements.arc,
                    ...
                    updateElement: function (t, i, a) {
                        for (var n = this, o = n.chart, r = n.getDataset(), l = o.options, s = l.animation, d = o.scale, u = e.getValueAtIndexOrDefault, c = o.data.labels, h = n.calculateCircumference(r.data[i]), f = d.xCenter, g = d.yCenter, p = 0, m = n.getMeta(), b = 0; b < i; ++b) isNaN(r.data[b]) || m.data[b].hidden || ++p;
                        var v = l.startAngle, x = t.hidden ? 0 : d.getDistanceFromCenterForValue(r.data[i]),
            ...
            e.exports = function (t) {
                ...
                t.defaults.radar = {
                    ...
                    linkScales: e.noop,
                    update: function (t) {
                        var i = this, a = i.getMeta(), n = a.dataset, o = a.data, r = n.custom || {},
                            l = i.getDataset(), s = i.chart.options.elements.line, d = i.chart.scale;
                    ...
                    updateElement: function (t, i, a) {
                        var n = this, o = t.custom || {}, r = n.getDataset(), l = n.chart.scale,
                            s = n.chart.options.elements.point, d = l.getPointPositionForValue(i, r.data[i]);
                        e.extend(t, {
                            _datasetIndex: n.index,
                            _index: i,
                            _scale: l,
                    ...
                    setHoverStyle: function (t) {
                        var i = this.chart.data.datasets[t._datasetIndex], a = t.custom || {}, n = t._index,
                            o = t._model;
            ...
            e.exports = function (t) {
                ...
                t.defaults.global.animation = {
                    ...
                    startDigest: function () {
                        ...
                        for (var a = 0; a < t.animations.length;) null === t.animations[a].animationObject.currentStep && (t.animations[a].animationObject.currentStep = 0), t.animations[a].animationObject.currentStep += 1 + i, t.animations[a].animationObject.currentStep > t.animations[a].animationObject.numSteps && (t.animations[a].animationObject.currentStep = t.animations[a].animationObject.numSteps), t.animations[a].animationObject.render(t.animations[a].chartInstance, t.animations[a].animationObject), t.animations[a].animationObject.onAnimationProgress && t.animations[a].animationObject.onAnimationProgress.call && t.animations[a].animationObject.onAnimationProgress.call(t.animations[a].chartInstance, t.animations[a]), t.animations[a].animationObject.currentStep === t.animations[a].animationObject.numSteps ? (t.animations[a].animationObject.onAnimationComplete && t.animations[a].animationObject.onAnimationComplete.call && t.animations[a].animationObject.onAnimationComplete.call(t.animations[a].chartInstance, t.animations[a]), t.animations[a].chartInstance.animating = !1, t.animations.splice(a, 1)) : ++a;
            ...
            e.exports = function (t) {
                function e(t, e) {
                    var i = r.getStyle(t, e), a = i && i.match(/(\d+)px/);
                    return a ? Number(a[1]) : void 0
                }

                function i(t, i) {
                    var a = t.style, n = t.getAttribute("height"), o = t.getAttribute("width");
                    if (t._chartjs = {
                            initial: {
                                height: n,
                                width: o,
                    ...
                    if (null === n || "" === n) if ("" === t.style.height) t.height = t.width / (i.options.aspectRatio || 2); else {
                        var l = e(t, "height");
                        void 0 !== r && (t.height = l)
                    }
                    return t
                ...
                function n(t, e) {
                    if ("string" == typeof t ? t = document.getElementById(t) : t.length && (t = t[0]), t && t.canvas && (t = t.canvas), t instanceof HTMLCanvasElement) {
                        ...
                        if (a instanceof CanvasRenderingContext2D) return i(t, e), a
                    }
                    return null
                }
                ...
                t.types = {}, t.instances = {}, t.controllers = {}, t.Controller = function (e, i, a) {
                    var l = this, s = n(e, i = o(i)), d = s && s.canvas, u = d && d.height, c = d && d.width;
                    ...
                    initialize: function () {
                        ...
                        var i = this, a = i.chart, n = i.options, o = a.canvas,
                            l = n.maintainAspectRatio && a.aspectRatio || null, s = Math.floor(r.getMaximumWidth(o)),
                        ...
                        var e = this, i = e.options, a = e.scales = {}, n = [];
                        i.scales && (n = n.concat((i.scales.xAxes || []).map(function (t) {
                            ...
                            var n = i.options, o = r.getValueOrDefault(n.type, i.dtype),
                        ...
                        if (r.each(e.data.datasets, function (n, o) {
                            ...
                            }, e), i.length > 1) for (var n = 1; n < i.length; n++) if (i[n] !== i[n - 1]) {
                            e.isCombo = !0;
                            break
                        }
                        return a
                        ...
                        if (t.plugins.notify("beforeDatasetsUpdate", [a])) {
                            for (e = 0, i = a.data.datasets.length; e < i; ++e) a.getDatasetMeta(e).controller.update();
                        ...
                        if (n && (void 0 !== e && 0 !== e || void 0 === e && 0 !== n.duration)) {
                            ...
                            o.numSteps = (e || n.duration) / 16.66, o.easing = n.easing, o.render = function (t, e) {
                                var i = r.easingEffects[e.easing], a = e.currentStep / e.numSteps, n = i(a);
                        ...
                        var e = this, i = e.data.datasets[t];
                        i._meta || (i._meta = {});
                        var a = i._meta[e.id];
                        ...
                        var e, i, n, o = this, l = o.chart.canvas;
                        for (o.stop(), i = 0, n = o.data.datasets.length; i < n; ++i) (e = o.getDatasetMeta(i)).controller && (e.controller.destroy(), e.controller = null);
                        ...
                        var a, n, o, r = i ? "setHoverStyle" : "removeHoverStyle";
                        for (n = 0, o = t.length; n < o; ++n) (a = t[n]) && this.getDatasetMeta(a._datasetIndex).controller[r](a)
                    }, eventHandler: function (t) {
                        var e = this, i = e.legend, a = e.tooltip, n = e.options.hover;
                        ...
                        var e = this, i = e.options || {}, a = i.hover, n = !1;
            ...
            e.exports = function (t) {
                ...
                function i(t, e) {
                    var i = t._chartjs;
                    if (i) {
                        var a = i.listeners, o = a.indexOf(e);
                ...
                var a = t.helpers, n = ["push", "pop", "shift", "splice", "unshift"];
                t.DatasetController = function (t, e) {
                    ...
                    addElements: function () {
                        var t, e, i = this, a = i.getMeta(), n = i.getDataset().data || [], o = a.data;
                        for (t = 0, e = n.length; t < e; ++t) o[t] = o[t] || i.createMetaData(t);
                    ...
                    buildOrUpdateElements: function () {
                        var t = this, a = t.getDataset(), n = a.data || (a.data = []);
                        t._data !== n && (t._data && i(t._data, t), e(n, t), t._data = n), t.resyncElements()
                    },
                    update: a.noop,
                    draw: function (t) {
                        var e, i, a = t || 1, n = this.getMeta().data;
                        for (e = 0, i = n.length; e < i; ++e) n[e].transition(a).draw()
                    },
                    removeHoverStyle: function (t, e) {
                        var i = this.chart.data.datasets[t._datasetIndex], n = t._index, o = t.custom || {},
                            r = a.getValueAtIndexOrDefault, l = t._model;
                    ...
                    setHoverStyle: function (t) {
                        var e = this.chart.data.datasets[t._datasetIndex], i = t._index, n = t.custom || {},
                            o = a.getValueAtIndexOrDefault, r = a.getHoverColor, l = t._model;
                    ...
                    resyncElements: function () {
                        var t = this, e = t.getMeta(), i = t.getDataset().data, a = e.data.length, n = i.length;
                ...
                t.elements = {}, t.Element = function (t) {
                    ...
                    initialize: function () {
                        ...
                        return i._view || (i._view = e.clone(i._model)), 1 === t ? (i._view = i._model, i._start = null, i) : (i._start || i.pivot(), e.each(i._model, function (a, n) {
                            if ("_" === n[0]) ; else if (i._view.hasOwnProperty(n)) if (a === i._view[n]) ; else if ("string" == typeof a) try {
                            ...
                            } else i._view[n] = a; else "number" != typeof a || isNaN(i._view[n]) ? i._view[n] = a : i._view[n] = a * t
                        }, i), i)
            ...
            e.exports = function (t) {
                ...
                function n(t, a, n) {
                    var o = document.defaultView, r = t.parentNode, l = o.getComputedStyle(t)[a],
                        s = o.getComputedStyle(r)[a], d = i(l), u = i(s), c = Number.POSITIVE_INFINITY;
                ...
                o.each = function (t, e, i, a) {
                    var n, r;
                    if (o.isArray(t)) if (r = t.length, a) for (n = r - 1; n >= 0; n--) e.call(i, t[n], n); else for (n = 0; n < r; n++) e.call(i, t[n], n); else if ("object" == typeof t) {
                        var l = Object.keys(t);
                        for (r = l.length, n = 0; n < r; n++) e.call(i, t[l[n]], l[n])
                    }
                }, o.clone = function (t) {
                    var e = {};
                    ...
                    for (var e = 1, i = arguments.length; e < i; e++) o.each(arguments[e], function (e, i) {
                        t[i] = e
                    });
                    return t
                    ...
                    return o.each(Array.prototype.slice.call(arguments, 1), function (e) {
                        o.each(e, function (e, a) {
                            var n = i.hasOwnProperty(a), r = n ? i[a] : {};
                    ...
                    var i = e.x - t.x, a = e.y - t.y, n = Math.sqrt(i * i + a * a), o = Math.atan2(a, i);
                    ...
                    var n = t.skip ? e : t, o = e, r = i.skip ? e : i,
                        l = Math.sqrt(Math.pow(o.x - n.x, 2) + Math.pow(o.y - n.y, 2)),
                        s = Math.sqrt(Math.pow(r.x - o.x, 2) + Math.pow(r.y - o.y, 2)), d = l / (l + s),
                        u = s / (l + s), c = a * (d = isNaN(d) ? 0 : d), h = a * (u = isNaN(u) ? 0 : u);
                    return {
                        previous: {x: o.x - c * (r.x - n.x), y: o.y - c * (r.y - n.y)},
                        next: {x: o.x + h * (r.x - n.x), y: o.y + h * (r.y - n.y)}
                    }
                }, o.EPSILON = Number.EPSILON || 1e-14, o.splineCurveMonotone = function (t) {
                    var e, i, a, n, r = (t || []).map(function (t) {
                        return {model: t._model, deltaK: 0, mK: 0}
                    }), l = r.length;
                    for (e = 0; e < l; ++e) (a = r[e]).model.skip || (i = e > 0 ? r[e - 1] : null, (n = e < l - 1 ? r[e + 1] : null) && !n.model.skip && (a.deltaK = (n.model.y - a.model.y) / (n.model.x - a.model.x)), !i || i.model.skip ? a.mK = a.deltaK : !n || n.model.skip ? a.mK = i.deltaK : this.sign(i.deltaK) !== this.sign(a.deltaK) ? a.mK = 0 : a.mK = (i.deltaK + a.deltaK) / 2);
                    var s, d, u, c;
                    for (e = 0; e < l - 1; ++e) a = r[e], n = r[e + 1], a.model.skip || n.model.skip || (o.almostEquals(a.deltaK, 0, this.EPSILON) ? a.mK = n.mK = 0 : (s = a.mK / a.deltaK, d = n.mK / a.deltaK, (c = Math.pow(s, 2) + Math.pow(d, 2)) <= 9 || (u = 3 / Math.sqrt(c), a.mK = s * u * a.deltaK, n.mK = d * u * a.deltaK)));
                    var h;
                    for (e = 0; e < l; ++e) (a = r[e]).model.skip || (i = e > 0 ? r[e - 1] : null, n = e < l - 1 ? r[e + 1] : null, i && !i.model.skip && (h = (a.model.x - i.model.x) / 3, a.model.controlPointPreviousX = a.model.x - h, a.model.controlPointPreviousY = a.model.y - h * a.mK), n && !n.model.skip && (h = (n.model.x - a.model.x) / 3, a.model.controlPointNextX = a.model.x + h, a.model.controlPointNextY = a.model.y + h * a.mK))
                }, o.nextItem = function (t, e, i) {
                    return i ? e >= t.length - 1 ? t[0] : t[e + 1] : e >= t.length - 1 ? t[t.length - 1] : t[e + 1]
                }, o.previousItem = function (t, e, i) {
                    return i ? e <= 0 ? t[t.length - 1] : t[e - 1] : e <= 0 ? t[0] : t[e - 1]
                }, o.niceNum = function (t, e) {
                    var i = Math.floor(o.log10(t)), a = t / Math.pow(10, i);
                ...
                o.requestAnimFrame = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function (t) {
                    ...
                    var i, a, n = t.originalEvent || t, r = t.currentTarget || t.srcElement,
                    ...
                    var e = t.parentNode, i = parseInt(o.getStyle(e, "padding-left"), 10),
                        a = parseInt(o.getStyle(e, "padding-right"), 10), n = e.clientWidth - i - a,
                        r = o.getConstraintWidth(t);
                    return isNaN(r) ? n : Math.min(n, r)
                }, o.getMaximumHeight = function (t) {
                    var e = t.parentNode, i = parseInt(o.getStyle(e, "padding-top"), 10),
                        a = parseInt(o.getStyle(e, "padding-bottom"), 10), n = e.clientHeight - i - a,
                    ...
                    if (1 !== e) {
                        var i = t.canvas, a = t.height, n = t.width;
                    ...
                    var n = (a = a || {}).data = a.data || {}, r = a.garbageCollect = a.garbageCollect || [];
                    ...
                    var a = t._chartjs = {resizer: i, ticking: !1}, n = function () {
                        a.ticking || (a.ticking = !0, o.requestAnimFrame.call(window, function () {
                            if (a.resizer) return a.ticking = !1, e()
                        }))
                    };
                    ...
                    for (i = 0, a = t.length; i < a; ++i) if (n = t[i], r = e[i], n instanceof Array && r instanceof Array) {
            ...
            e.exports = function (t) {
                function e(t, e) {
                    var i, a, n, o, r;
                    for (a = 0, o = t.data.datasets.length; a < o; ++a) if (t.isDatasetVisible(a)) for (n = 0, r = (i = t.getDatasetMeta(a)).data.length; n < r; ++n) {
                        var l = i.data[n];
                        l._view.skip || e(l)
                    }
                }
                ...
                function a(t, i, a, n) {
                    ...
                    return n || (n = o.distanceBetweenPoints), e(t, function (t) {
                        if (!a || t.inRange(i.x, i.y)) {
                            var e = t.getCenterPoint(), o = n(i, e);
                ...
                function n(t, e, n) {
                    var r = o.getRelativePosition(e, t.chart), l = n.intersect ? i(t, r) : a(t, r, !1, function (t, e) {
                ...
                t.Interaction = {
                    modes: {
                        single: function (t, i) {
                            var a = o.getRelativePosition(i, t.chart), n = [];
                            return e(t, function (t) {
                                if (t.inRange(a.x, a.y)) return n.push(t), n
                            }), n.slice(0, 1)
                        }, label: n, index: n, dataset: function (t, e, n) {
                            var r = o.getRelativePosition(e, t.chart), l = n.intersect ? i(t, r) : a(t, r, !1);
                            ...
                            var n = o.getRelativePosition(i, t.chart), r = [], l = !1;
                            return e(t, function (t) {
                    ...
                    defaults: {}, addBox: function (t, e) {
                        ...
                        function n(t) {
                            ...
                            if (i) if (t.isHorizontal()) {
                                var a = {left: C, right: D, top: 0, bottom: 0};
                                t.update(t.options.fullWidth ? b : S, v / 2, a)
                            } else t.update(i.minSize.width, w)
                        }
                        ...
                        if (t) {
                            var r = t.options.layout, l = r ? r.padding : null, s = 0, d = 0, u = 0, c = 0;
                            ...
                            var b = i - s - d, v = a - u - c, x = v / 2, y = (i - b / 2) / (h.length + f.length),
                                k = (a - x) / (g.length + p.length), S = b, w = v, M = [];
                            ...
                            e.each(h.concat(f), n), e.each(h, function (t) {
                                ...
                                var i = e.findNextWhere(M, function (e) {
                                    return e.box === t
                                }), a = {left: 0, right: 0, top: I, bottom: A};
            ...
            e.exports = function (t) {
                ...
                t.defaults.global.legend = {
                    ...
                    reverse: !1,
                    onClick: function (t, e) {
                        var i = e.datasetIndex, a = this.chart, n = a.getDatasetMeta(i);
                    ...
                    initialize: function (t) {
                    ...
                    }, beforeUpdate: a, update: function (t, e, i) {
                        var a = this;
                        ...
                        var a = this, n = a.options, o = n.labels, r = n.display, l = a.ctx, s = t.defaults.global,
                            d = i.getValueOrDefault, u = d(o.fontSize, s.defaultFontSize),
                            c = d(o.fontStyle, s.defaultFontStyle), h = d(o.fontFamily, s.defaultFontFamily),
                            f = i.fontString(u, c, h), g = a.legendHitBoxes = [], p = a.minSize, m = a.isHorizontal();
                        if (m ? (p.width = a.maxWidth, p.height = r ? 10 : 0) : (p.width = r ? 10 : 0, p.height = a.maxHeight), r) if (l.font = f, m) {
                            var b = a.lineWidths = [0], v = a.legendItems.length ? u + o.padding : 0;
                            ...
                            var x = o.padding, y = a.columnWidths = [], k = o.padding, S = 0, w = 0, M = u + x;
                        ...
                        var a = this, n = a.options, o = n.labels, r = t.defaults.global, l = r.elements.line,
                            s = a.width, d = a.lineWidths;
                        if (n.display) {
                            var u, c = a.ctx, h = i.getValueOrDefault, f = h(o.fontColor, r.defaultFontColor),
                                g = h(o.fontSize, r.defaultFontSize), p = h(o.fontStyle, r.defaultFontStyle),
                                m = h(o.fontFamily, r.defaultFontFamily), b = i.fontString(g, p, m);
                            c.textAlign = "left", c.textBaseline = "top", c.lineWidth = .5, c.strokeStyle = f, c.fillStyle = f, c.font = b;
                            var v = e(o, g), x = a.legendHitBoxes, y = function (e, i, a) {
                                if (!(isNaN(v) || v <= 0)) {
                            ...
                            i.each(a.legendItems, function (t, e) {
                                var i = c.measureText(t.text).width, n = v + g / 2 + i, r = u.x, l = u.y;
                        ...
                        var e = this, a = e.options, n = "mouseup" === t.type ? "click" : t.type, o = !1;
                        if ("mousemove" === n) {
                            if (!a.onHover) return
                        } else {
                            if ("click" !== n) return;
                        ...
                        var r = i.getRelativePosition(t, e.chart.chart), l = r.x, s = r.y;
            ...
            e.exports = function (t) {
                ...
                t.plugins = {
                    _plugins: [], register: function (t) {
                        ...
                        var i, a, n = this._plugins, o = n.length;
                        for (i = 0; i < o; ++i) if ("function" == typeof(a = n[i])[t] && !1 === a[t].apply(a, e || [])) return !1;
                        return !0
                    }
            ...
            e.exports = function (t) {
                ...
                t.defaults.scale = {
                    ...
                    calculateTickRotation: function () {
                        var i = this, a = i.ctx, n = t.defaults.global, o = i.options.ticks,
                        ...
                        a.font = d;
                        var u, c = a.measureText(i.ticks[0]).width,
                    ...
                    fit: function () {
                        var i = this, a = i.minSize = {width: 0, height: 0}, n = i.options, o = t.defaults.global,
                            r = n.ticks, l = n.scaleLabel, s = n.gridLines, d = n.display, u = i.isHorizontal(),
                        ...
                        if (a.width = u ? i.isFullWidth() ? i.maxWidth - i.margins.left - i.margins.right : i.maxWidth : d && s.drawTicks ? m : 0, a.height = u ? d && s.drawTicks ? m : 0 : i.maxHeight, l.display && d && (u ? a.height += 1.5 * p : a.width += 1.5 * p), r.display && d) {
                            ...
                            var b = e.longestText(i.ctx, g, i.ticks, i.longestTextCache),
                                v = e.numberOfLabelLines(i.ticks), x = .5 * c;
                            if (u) {
                    ...
                    draw: function (i) {
                        var a = this, n = a.options;
                        if (n.display) {
                            var o, r, l = a.ctx, s = t.defaults.global, d = n.ticks, u = n.gridLines, c = n.scaleLabel,
                                h = 0 !== a.labelRotation, f = d.autoSkip, g = a.isHorizontal();
                            ...
                            var p = e.getValueOrDefault(d.fontColor, s.defaultFontColor),
                                ...
                                A = e.toRadians(a.labelRotation), T = Math.cos(A), P = a.longestLabelWidth * T;
                            l.fillStyle = p;
                            var F = [];
                            if (g) {
                                if (o = !1, h && (P /= 2), (P + d.autoSkipPadding) * a.ticks.length > a.width - (a.paddingLeft + a.paddingRight) && (o = 1 + Math.floor((P + d.autoSkipPadding) * a.ticks.length / (a.width - (a.paddingLeft + a.paddingRight)))), r && a.ticks.length > r) for (; !o || a.ticks.length / (o || 1) > r;) o || (o = 1), o += 1;
                                f || (o = !1)
                            }
                            ...
                            if (e.each(a.ticks, function (t, r) {
                                    if (void 0 !== t && null !== t) {
                                        ...
                                        if ((!(o > 1 && r % o > 0 || r % o == 0 && r + o >= a.ticks.length) || l) && void 0 !== t && null !== t) {
                                            ...
                                            var f, p, m, b, v, x, w, M, C, D, I = "middle", T = "middle";
                                            if (g) {
                                    ...
                                    if (u.display && (l.save(), l.lineWidth = t.glWidth, l.strokeStyle = t.glColor, l.setLineDash && (l.setLineDash(t.glBorderDash), l.lineDashOffset = t.glBorderDashOffset), l.beginPath(), u.drawTicks && (l.moveTo(t.tx1, t.ty1), l.lineTo(t.tx2, t.ty2)), u.drawOnChartArea && (l.moveTo(t.x1, t.y1), l.lineTo(t.x2, t.y2)), l.stroke(), l.restore()), d.display) {
                                        ...
                                        var i = t.label;
                                        if (e.isArray(i)) for (var a = 0, n = -(i.length - 1) * m * .75; a < i.length; ++a) l.fillText("" + i[a], 0, n), n += 1.5 * m; else l.fillText(i, 0, 0);
                                        l.restore()
                                    }
                                }), c.display) {
                                var O, B, W = 0;
                                if (g) O = a.left + (a.right - a.left) / 2, B = "bottom" === n.position ? a.bottom - M / 2 : a.top + M / 2; else {
                            ...
                            if (u.drawBorder) {
                                ...
                                var N = a.left, E = a.right, H = a.top, U = a.bottom, j = e.aliasPixel(l.lineWidth);
                ...
                t.Ticks = {
                    generators: {
                        linear: function (t, i) {
                            ...
                            var r = Math.floor(i.min / a) * a, l = Math.ceil(i.max / a) * a;
                            ...
                            for (var d = 1; d < s; ++d) n.push(r + d * a);
            ...
            e.exports = function (t) {
                ...
                t.Title = t.Element.extend({
                    ...
                    beforeFit: i,
                    fit: function () {
                        var i = this, a = e.getValueOrDefault, n = i.options, o = t.defaults.global, r = n.display,
                            l = a(n.fontSize, o.defaultFontSize), s = i.minSize;
                    ...
                    draw: function () {
                        var i = this, a = i.ctx, n = e.getValueOrDefault, o = i.options, r = t.defaults.global;
                        if (o.display) {
                            var l, s, d, u = n(o.fontSize, r.defaultFontSize), c = n(o.fontStyle, r.defaultFontStyle),
                                h = n(o.fontFamily, r.defaultFontFamily), f = e.fontString(u, c, h), g = 0, p = i.top,
                                m = i.left, b = i.bottom, v = i.right;
            ...
            e.exports = function (t) {
                ...
                function a(t) {
                    var e = t._xScale, i = t._yScale || t._scale, a = t._index, n = t._datasetIndex;
                    return {
                ...
                function n(e) {
                    var i = t.defaults.global, a = s.getValueOrDefault;
                    return {
                        xPadding: e.xPadding,
                        yPadding: e.yPadding,
                        xAlign: e.xAlign,
                ...
                function o(t, e) {
                    var i = t._chart.ctx, a = 2 * e.yPadding, n = 0, o = e.body, r = o.reduce(function (t, e) {
                ...
                function r(t, e) {
                    var i = t._model, a = t._chart, n = t._chartInstance.chartArea, o = "center", r = "center";
                ...
                function l(t, e, i) {
                    var a = t.x, n = t.y, o = t.caretSize, r = t.caretPadding, l = t.cornerRadius, s = i.xAlign,
                        d = i.yAlign, u = o + r, c = l + r;
                ...
                t.defaults.global.tooltips = {
                    ...
                    callbacks: {
                        beforeTitle: s.noop,
                        title: function (t, e) {
                            var i = "", a = e.labels, n = a ? a.length : 0;
                            if (t.length > 0) {
                                var o = t[0];
                    ...
                    initialize: function () {
                        ...
                        var a = this, n = a._options.callbacks, o = [];
                        ...
                        var i, d, u = this, c = u._options, h = u._model, f = u._model = n(c), g = u._active,
                        ...
                        if (g.length) {
                            ...
                            var S = [];
                            for (i = 0, d = g.length; i < d; ++i) S.push(a(g[i]));
                        ...
                        var n, o, r, l, s, d, u = this._view, c = this._chart.ctx, h = u.caretSize, f = u.cornerRadius,
                            g = u.xAlign, p = u.yAlign, m = t.x, b = t.y, v = i.width, x = i.height;
                        ...
                        if (o.length) {
                            ...
                            var r = i.titleFontSize, l = i.titleSpacing;
                            a.fillStyle = e(i.titleFontColor, n), a.font = s.fontString(r, i._titleFontStyle, i._titleFontFamily);
                            var d, u;
                            for (d = 0, u = o.length; d < u; ++d) a.fillText(o[d], t.x, t.y), t.y += r + l, d + 1 === o.length && (t.y += i.titleMarginBottom - l)
                        }
                    }, drawBody: function (t, i, a, n) {
                        var o = i.bodyFontSize, r = i.bodySpacing, l = i.body;
                        ...
                        if (0 !== e.opacity) {
                            var i = {width: e.width, height: e.height}, a = {x: e.x, y: e.y},
                    ...
                    average: function (t) {
                        ...
                        return {x: Math.round(a / o), y: Math.round(n / o)}
                    }, nearest: function (t, e) {
                        var i, a, n, o = e.x, r = e.y, l = Number.POSITIVE_INFINITY;
                    ...
                    inLabelRange: function (t) {
                        ...
                        if (a) {
                            for (var n = e.getAngleFromPoint(a, {
                                x: t,
                                y: i
                            }), o = n.angle, r = n.distance, l = a.startAngle, s = a.endAngle; s < l;) s += 2 * Math.PI;
                            for (; o > s;) o -= 2 * Math.PI;
                            for (; o < l;) o += 2 * Math.PI;
                            var d = o >= l && o <= s, u = r >= a.innerRadius && r <= a.outerRadius;
                            return d && u
                        }
                        return !1
            ...
            e.exports = function (t) {
                ...
                t.defaults.global.elements.line = {
                    ...
                    draw: function () {
                        ...
                        var a = this, n = a._view, o = n.spanGaps, r = n.scaleZero, l = a._loop;
                        l || ("top" === n.fill ? r = n.scaleTop : "bottom" === n.fill && (r = n.scaleBottom));
                        var s = a._chart.ctx;
                        s.save();
                        var d = a._children.slice(), u = -1;
            ...
            e.exports = function (t) {
                ...
                var i = t.helpers, a = t.defaults.global, n = a.defaultColor;
                a.elements.point = {
                    radius: 3,
                    pointStyle: "circle",
                    backgroundColor: n,
                    ...
                    inRange: function (t, e) {
                        ...
                        var e = this._view, o = this._chart.ctx, r = e.pointStyle, l = e.radius, s = e.x, d = e.y;
            ...
            e.exports = function (t) {
                ...
                function i(t) {
                    ...
                    return {left: i, top: n, right: a, bottom: o}
                }
                ...
                a.elements.rectangle = {
                    ...
                    draw: function () {
                        ...
                        var e = this._chart.ctx, i = this._view, a = i.width / 2, n = i.x - a, o = i.x + a,
                            r = i.base - (i.base - i.y), l = i.borderWidth / 2;
                        i.borderWidth && (n += l, o -= l, r += l), e.beginPath(), e.fillStyle = i.backgroundColor, e.strokeStyle = i.borderColor, e.lineWidth = i.borderWidth;
            ...
            e.exports = function (t) {
                var e = t.helpers, i = {position: "bottom"}, a = t.Scale.extend({
                    getLabels: function () {
                        ...
                        var i = this, a = i.chart.data, n = i.isHorizontal();
                ...
                var e = t.helpers, i = {position: "left", ticks: {callback: t.Ticks.formatters.linear}},
                    a = t.LinearScaleBase.extend({
                        determineDataLimits: function () {
                            ...
                            var i = this, a = i.options, n = i.chart, o = n.data.datasets, r = i.isHorizontal();
                            if (i.min = null, i.max = null, a.stacked) {
                                ...
                                e.each(o, function (o, r) {
                                    ...
                                    var d = l[s.type].positiveValues, u = l[s.type].negativeValues;
                                    ...
                                    var a = t.positiveValues.concat(t.negativeValues), n = e.min(a), o = e.max(a);
                                    i.min = null === i.min ? n : Math.min(i.min, n), i.max = null === i.max ? o : Math.max(i.max, o)
                                })
                            } else e.each(o, function (a, o) {
                            ...
                            var i, a = this, n = a.options.ticks;
                            if (a.isHorizontal()) i = Math.min(n.maxTicksLimit ? n.maxTicksLimit : 11, Math.ceil(a.width / 50)); else {
                            ...
                            var e, i, a = this, n = a.paddingLeft, o = a.paddingBottom, r = a.start,
                                l = +a.getRightValue(t), s = a.end - r;
                            ...
                            var e = this, i = e.isHorizontal(), a = e.paddingLeft, n = e.paddingBottom,
            ...
            e.exports = function (t) {
                ...
                t.LinearScaleBase = t.Scale.extend({
                    handleTickRangeOptions: function () {
                        ...
                        if (i.beginAtZero) {
                            var a = e.sign(t.min), n = e.sign(t.max);
                        ...
                        var i = this, a = i.options.ticks, n = i.getTickLimit(), o = {
                ...
                var e = t.helpers, i = {position: "left", ticks: {callback: t.Ticks.formatters.logarithmic}},
                    a = t.Scale.extend({
                        determineDataLimits: function () {
                            ...
                            var i = this, a = i.options, n = a.ticks, o = i.chart, r = o.data.datasets,
                                l = e.getValueOrDefault, s = i.isHorizontal();
                            ...
                            var i = this, a = i.options.ticks, n = {min: a.min, max: a.max},
                            ...
                            var i, a, n, o = this, r = o.start, l = +o.getRightValue(t), s = o.paddingTop,
                                d = o.paddingBottom, u = o.paddingLeft, c = o.options.ticks;
                            ...
                            var i, a, n = this, o = e.log10(n.end) - e.log10(n.start);
            ...
            e.exports = function (t) {
                var e = t.helpers, i = t.defaults.global, a = {
                    ...
                    getValueCount: function () {
                        ...
                        var t = this, a = t.options, n = a.ticks;
                        t.width = t.maxWidth, t.height = t.maxHeight, t.xCenter = Math.round(t.width / 2), t.yCenter = Math.round(t.height / 2);
                        var o = e.min([t.height, t.width]), r = e.getValueOrDefault(n.fontSize, i.defaultFontSize);
                        ...
                        var t = this.options.ticks, a = e.getValueOrDefault(t.fontSize, i.defaultFontSize);
                        ...
                        var t, a, n, o, r, l, s, d, u, c, h, f, g = this.options.pointLabels,
                        ...
                        var i = this, a = i.getIndexAngle(t);
                        return {x: Math.round(Math.cos(a) * e) + i.xCenter, y: Math.round(Math.sin(a) * e) + i.yCenter}
                        ...
                        var t = this, a = t.options, n = a.gridLines, o = a.ticks, r = a.angleLines, l = a.pointLabels,
                            s = e.getValueOrDefault;
                        if (a.display) {
                            var d = t.ctx, u = s(o.fontSize, i.defaultFontSize), c = s(o.fontStyle, i.defaultFontStyle),
                                h = s(o.fontFamily, i.defaultFontFamily), f = e.fontString(u, c, h);
                            if (e.each(t.ticks, function (r, l) {
                                    if (l > 0 || a.reverse) {
                                        var c = t.getDistanceFromCenterForValue(t.ticksAsNumbers[l]), h = t.yCenter - c;
                                        if (n.display && 0 !== l) if (d.strokeStyle = e.getValueAtIndexOrDefault(n.color, l - 1), d.lineWidth = e.getValueAtIndexOrDefault(n.lineWidth, l - 1), a.lineArc) d.beginPath(), d.arc(t.xCenter, t.yCenter, c, 0, 2 * Math.PI), d.closePath(), d.stroke(); else {
                                            d.beginPath();
                                ...
                                for (var g = t.getDistanceFromCenterForValue(a.reverse ? t.min : t.max), p = s(l.fontSize, i.defaultFontSize), m = s(l.fontStyle, i.defaultFontStyle), b = s(l.fontFamily, i.defaultFontFamily), v = e.fontString(p, m, b), x = t.getValueCount() - 1; x >= 0; x--) {
                                    ...
                                    var k = t.getPointPosition(x, g + 5), S = s(l.fontColor, i.defaultFontColor);
                    ...
                    initialize: function () {
                        ...
                        if (a.ctx.font = l, a.ticks = [], a.unitScale = 1, a.scaleSizeInUnits = 0, a.options.time.unit) a.tickUnit = a.options.time.unit || "day", a.displayFormat = a.options.time.displayFormats[a.tickUnit], a.scaleSizeInUnits = a.lastTick.diff(a.firstTick, a.tickUnit, !0), a.unitScale = e.getValueOrDefault(a.options.time.unitStepSize, 1); else {
                            var s = a.isHorizontal() ? a.width - (a.paddingLeft + a.paddingRight) : a.height - (a.paddingTop + a.paddingBottom),
                                d = a.tickFormatFunction(a.firstTick, 0, []), u = a.ctx.measureText(d).width,
                            ...
                            for (var h = 0, f = i.units[h]; h < i.units.length;) {
                                if (a.unitScale = 1, e.isArray(f.steps) && Math.ceil(a.scaleSizeInUnits / c) < e.max(f.steps)) {
                                    for (var g = 0; g < f.steps.length; ++g) if (f.steps[g] >= Math.ceil(a.scaleSizeInUnits / c)) {
                        ...
                        if (a.options.time.min ? b = a.getMomentStartOf(a.firstTick) : (a.firstTick = a.getMomentStartOf(a.firstTick), b = a.firstTick), !a.options.time.max) {
                            var v = a.getMomentStartOf(a.lastTick), x = v.diff(a.lastTick, a.tickUnit, !0);
                        ...
                        for (var y = 1; y <= a.scaleSizeInUnits; ++y) {
                            ...
                            if (a.options.time.max && k.diff(a.lastTick, a.tickUnit, !0) >= 0) break;
