...
function chartSixBigLossesInit(title, series) {
    ...
    if (series == null) {
        ...
        rtsOEEM.sblEquipmentFailure.rate.push(Math.round(5 + (Math.random() * 15)));
        ...
        rtsOEEM.sblSetupAndAdjustments.rate.push(Math.round(5 + (Math.random() * 15)));
        ...
        rtsOEEM.sblIdlingAndMinorStops.rate.push(Math.round(5 + (Math.random() * 15)));
        ...
        rtsOEEM.sblReducedSpeed.rate.push(Math.round(5 + (Math.random() * 15)));
        chartSeries.push(rtsOEEM.sblReducedSpeed.rate[rtsOEEM.sblReducedSpeed.rate.length - 1]);
        rtsOEEM.sblProcessDefects.rate.shift();
        rtsOEEM.sblProcessDefects.rate.push(Math.round(5 + (Math.random() * 15)));
        ...
        rtsOEEM.sblReducedYield.rate.push(Math.round(5 + (Math.random() * 15)));
...
function chartFloorMapReafresh() {
    ...
    var ele = document.getElementsByClassName("highcharts-Pad90x60x3-box");
...
function chartFloorMapInit(title, series) {
    var OPs = [
        {
            text: '<u>OP 10</u><br>LaserMarker<br>#1 Pinion', 'x': 60, 'y': 5 + 25 + 0 * 80, 'padType': 'Pad90x60x3'
        }, {
            text: '<u>OP 10</u><br>LaserMarker<br>#2 Pinion', 'x': 60, 'y': 5 + 25 + 1 * 80, 'padType': 'Pad90x60x3'
        }, {
            text: '<u>OP 10</u><br>LaserMarker<br>#1 Ring', 'x': 60, 'y': 5 + 25 + 2 * 80, 'padType': 'Pad90x60x3'
        }, {
            text: '<u>OP 10</u><br>LaserMarker<br>#2 Ring', 'x': 60, 'y': 5 + 25 + 3 * 80, 'padType': 'Pad90x60x3'
        }, {
            text: '<u>OP 10</u><br>LaserMarker<br>#3 Ring', 'x': 60, 'y': 5 + 25 + 4 * 80, 'padType': 'Pad90x60x3'
        },

        {
            text: '<u>OP 20</u><br>Cutter<br>#1 Pinion', 'x': 280, 'y': 5 + 65 + 0 * 80, 'padType': 'Pad90x60x3'
        }, {
            text: '<u>OP 20</u><br>Cutter<br>#2 Pinion', 'x': 390, 'y': 5 + 65 + 0 * 80, 'padType': 'Pad90x60x3'
        }, {
            text: '<u>OP 20</u><br>Cutter<br>#3 Pinion', 'x': 390, 'y': 5 + 65 + 1 * 80, 'padType': 'Pad90x60x3'
        }, {
            text: '<u>OP 20</u><br>Cutter<br>#4 Pinion', 'x': 390, 'y': 5 + 65 + 2 * 80, 'padType': 'Pad90x60x3'
        }, {
            text: '<u>OP 20</u><br>Cutter<br>#5 Pinion', 'x': 390, 'y': 5 + 65 + 3 * 80, 'padType': 'Pad90x60x3'
        }, {
            text: '<u>OP 20</u><br>Cutter<br>#6 Pinion', 'x': 280, 'y': 5 + 65 + 3 * 80, 'padType': 'Pad90x60x3'
        },

        {
            text: '<u>OP 20</u><br>Cutter<br>#1 Ring', 'x': 610, 'y': 5 + 65 + 0 * 80, 'padType': 'Pad90x60x3'
        }, {
            text: '<u>OP 20</u><br>Cutter<br>#2 Ring', 'x': 490, 'y': 5 + 65 + 0 * 80, 'padType': 'Pad90x60x3'
        }, {
            text: '<u>OP 20</u><br>Cutter<br>#3 Ring', 'x': 490, 'y': 5 + 65 + 1 * 80, 'padType': 'Pad90x60x3'
        }, {
            text: '<u>OP 20</u><br>Cutter<br>#4 Ring', 'x': 490, 'y': 5 + 65 + 2 * 80, 'padType': 'Pad90x60x3'
        }, {
            text: '<u>OP 20</u><br>Cutter<br>#5 Ring', 'x': 490, 'y': 5 + 65 + 3 * 80, 'padType': 'Pad90x60x3'
        }, {
            text: '<u>OP 20</u><br>Cutter<br>#6 Ring', 'x': 610, 'y': 5 + 65 + 3 * 80, 'padType': 'Pad90x60x3'
        },

        {
            text: '<u>Furnace #1</u><br>Pinions<br>Rings', 'x': 940, 'y': 5 + 65 + 0 * 80, 'padType': 'Pad90x60x3'
        }, {
            text: '<u>Furnace #2</u><br>Pinions<br>Rings', 'x': 940, 'y': 5 + 65 + 1 * 80, 'padType': 'Pad90x60x3'
        }, {
            text: '<u>Furnace #3</u><br>Pinions<br>Rings', 'x': 940, 'y': 5 + 65 + 2 * 80, 'padType': 'Pad90x60x3'
        }, {
            text: '<u>Furnace #4</u><br>Pinions<br>Rings', 'x': 940, 'y': 5 + 65 + 3 * 80, 'padType': 'Pad90x60x3'
        },
    ];
        ...
        chart: {
            ...
            events: {
                load: function () {
                    ...
                    ren.path(['M', 435, 30, 'L', 435, 80,]).attr({
                        'stroke-width': 5,
                        stroke: '#c0c0c0'
                    }).add();
                    ren.path(['M', 535, 30, 'L', 535, 80,]).attr({
                        'stroke-width': 5,
                        stroke: '#c0c0c0'
                    }).add();
                    ...
                    ren.image('Common/img/pc.png', 730, 35, 90, 80).add();
                    ren.image('Common/img/pc.png', 730, 275, 90, 80).add();
                    ren.image('Common/img/scanner.png', 200, 175, 50, 50).add();
                    ren.image('Common/img/scanner.png', 630, 175, 50, 50).add();
                    ren.image('Common/img/scanner.png', 855, 70, 50, 50).add();
                    ren.image('Common/img/scanner.png', 855, 290, 50, 50).add();
    ...
    var ELE = document.getElementsByClassName("highcharts-Pad90x60x3-box");// Pad's size
    $.each(ELE, function (i, ele) {
        ele.setAttribute("width", 80);
        ele.setAttribute("height", 50);
    });

    var ELE = document.getElementsByClassName("highcharts-label highcharts-Pad90x60x3");//Font's size
    $.each(ELE, function (i, ele) {
        if (ele.nodeName == 'DIV') {
...
function chartOeeTrendRefresh() {
    ...
    chartOeeTrend.series[0].addPoint([ts, (rtsOEEM.availability * rtsOEEM.performance * rtsOEEM.quality / 10000) | 0], true, false);
}

function chartSixBigLossesRefresh() {
    var chartSeries = [
    ...
    chartSixBigLosses.series[0].setData(chartSeries);
    chartSixBigLosses.series[1].setData(
        [
            chartSeries[0],
            chartSeries[0] + chartSeries[1],
            chartSeries[0] + chartSeries[1] + chartSeries[2],
